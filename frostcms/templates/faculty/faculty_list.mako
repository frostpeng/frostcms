...
<body>
<div class="list_head">
	<div class="list_name">&nbsp;&nbsp;&nbsp;学院信息管理</div>
	<div class="head_app">
		...
		<div class="add">
		<a href="" role="button" data-toggle="modal">添加专业</a>
		</div>
	</div>	
</div>
</div>
...
<tfoot>
    ...
    <tbody>
      ...
      <tr>
        <td>${item.name}</td>
        <td class="handle">
        	<a href="/student/add?mentorid=${item.id}">编辑</a>
			<a href="/student/delete?mentorid=${item.id}">删除</a>
		</td>
      </tr>
      % endfor
    </tbody>
