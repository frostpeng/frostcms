...
<body>
	...
	<div class="right">
		...
		<div class="right_head">
			...
			% if course:
			<a class="btn btn-primary" id="btn_head" href="/mentor/lesson/listbycourse?courseid=${course.id}"><i class="icon-share-alt icon-white"></i> 课堂列表</a>   			
			% endif
		</div>
        
        <!-- 主体信息表 -->
        <div class="right_main">
        	<form action="/mentor/lesson/save" class="add" name="course">
        	 	%if lesson:
