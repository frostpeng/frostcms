        	...
        	<form action="/lesson/save" class="add" name="course">
        	   <br />
				<div class="input-prepend">
  					...
  					<span class="add-on">${upload.title if upload else u''}</span>
				</div>
				<br />
				<div class="input-prepend">
  					<span class="add-on">描述</span>
  					<span class="add-on">${upload.description if upload else u''}</span>
  				</div>
				<br />
				<div class="input-prepend" id="download_div">
					<span class='add-on'>已上传附件</span>
					<span class='add-on'><a href='/user/getfilebyid?fsfileid=${upload.fsfileid}'>附件下载</a></span>
				</div>
				<br />
				<div class="input-prepend">
					<span class='add-on'>分数</span>
					<span class='add-on'>${upload.mark}</span>
				</div>
				<hr />
				<span id="debug"></span>
 			</form>
